...
MAIN_KBD = (
    Keyboard()
    .add(Text("плыть", payload={"cmd": "sailed"}), color=Color.NEGATIVE)
...
FORMAT_KBD = (
    ...
    .add(Text("Отформаченный", payload={"cmd": "unix_time_formatted"}), color=Color.NEGATIVE)
    .row()
    .add(Text("Неотформаченный", payload={"cmd": "unix_time_unformatted"}), color=Color.POSITIVE)
)
